(function ($) {
  ...
  var assetLoader = (function () {
    this.imgs = {
      'bg': 'https://lh5.ggpht.com/WxFFoxmJpxmPnbZmGcZxd0El58ReJJ4r4bZF1OHU55NwJ67inn55QYdKJvWUc68YKg=h900',
      'sky': '',
      'backdrop': '',
      'backdrop2': '',
      'grass': 'imgs/grass_.png',
      'avatar_normal': 'imgs/normal_walk.png',
      'water': 'imgs/water_.png',
      'grass1': 'imgs/grassMid2.png',
      'grass2': 'imgs/grassMid2.png',
      'bridge': 'imgs/bridge_.png',
      'plant': 'imgs/plant_.png',
      'bush1': 'imgs/bush1.png',
      'bush2': 'imgs/bush2.png',
      'cliff': 'imgs/grassCliffRight_.png',
      'spikes': 'imgs/spikes_.png',
      'box': 'imgs/box.png',
  ...
  function animate() {
    if (!stop) {
      ...
      ctx.fillText('Recorido: ' + score + 'm', canvas.width - 140, 30);
