...
var imageRepository = new function () {
    ...
    this.background.src = "img/1066768007.jpg";
    this.spaceship.src = "img/ship.png";
    this.bullet.src = "img/bala.png";
    this.enemy.src = "img/ship_enemy.png";
    this.enemyBullet.src = "img/bala_enemigo.png";
}
...
function Game() {
    this.init = function () {
        ...
        if (this.bgCanvas.getContext) {
            ...
            this.backgroundAudio = new Audio("sounds/sountrack.wav");
            this.backgroundAudio.loop = true;
            this.backgroundAudio.volume = .25;
            this.backgroundAudio.load();

            this.gameOverAudio = new Audio("sounds/final_del_juego.mp3");
