(function(){
    ...
    let piramid = new THREE.TextureLoader();
    let cube = new THREE.TextureLoader();
    //let torus = new THREE.TextureLoader();

    piramid.load('public/img/map.jpg', function(texture){
        var geometry = new THREE.TorusGeometry( 10, 3, 200, 160 );
